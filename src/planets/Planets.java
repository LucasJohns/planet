...
public class Planets extends Application {
    ...
    public void start(Stage primaryStage) {
        Label lbTitle = new Label("Planetary Weight");
        lbTitle.setStyle("-fx-font-size: 24pt; -fx-text-fill: #000000;");
        HBox hBoxTitle = new HBox();
        hBoxTitle.setAlignment(Pos.CENTER);
        hBoxTitle.getChildren().add(lbTitle);

        GridPane gridPane = new GridPane();
        gridPane.setStyle("-fx-hgap: 5; -fx-vgap: 1; -fx-padding: 10; -fx-alignment: center");
        ...
        lbMoon.setStyle("-fx-font-size: 18pt; -fx-text-fill: #000000;");
        ...
        lbVenus.setStyle("-fx-font-size: 18pt; -fx-text-fill: #000000;");
        ...
        btn.setStyle("-fx-font-size: 18pt; -fx-padding: 10; -fx-text-fill: #0000000;");
